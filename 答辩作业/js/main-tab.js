$('.menu').click(function () {
    ...
    switch ($(this).data("number")) {
        case 1:
            ...
            $(".loading-bg").css('background-color', '#009688');
            break;
        ...
        case 2:
            ...
            $(".loading-bg").css('background-color', '#EC407A');
            break;
        case 3:
            ...
            $(".loading-bg").css('background-color', '#2196F3');
            break;
        case 4:
            ...
            $(".loading-bg").css('background-color', '#f44336');
            break;
        case 5:
            $(".top-bar").css('background-color', '#009688');
            $(".top-bar-tab").css('background-color', '#009688');
